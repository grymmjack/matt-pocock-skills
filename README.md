...
- **[python-env](./skills/engineering/python-env/SKILL.md)** — Explore a Python environment the fuzzy way: browse installed packages, read their source, and jump to their PyPI/docs, with an fzf browser (`pybrowse`) that's a sibling of `brewbrowse`/`aptbrowse`.
