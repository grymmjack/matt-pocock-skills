...
- **[env-browser](./env-browser/SKILL.md)** — Explore a project's package environment the fuzzy way: browse installed packages, read their source, and jump to their registry/docs — for Python, Node, Rust, Go, and Ruby (`pybrowse`/`nodebrowse`/`rustbrowse`/`gobrowse`/`gembrowse`).
